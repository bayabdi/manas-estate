...
def main():
    ...
    require("https://apexjld.com/" in html, "site must declare the apexjld public URL")
    require("Manas Estate" not in html, "public site must not expose old Manas Estate brand")
    require("apexjld" in html, "public site must expose the apexjld brand")
